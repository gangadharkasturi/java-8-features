...
public class StreamApiUsage5 {
	...
	public static void main(String[] args) {
		...
		Stream s2 = s.map(f); //Now every number has been multiplied by 2.
		Integer result = (Integer)s2.reduce(0,b); //here 0 is starting position.
